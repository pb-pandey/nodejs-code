...
app.use(cors({
    origin:['http://'+env.ipAddress+':4200','http://localhost:4200','https://localhost:65507','https://localhost','http://localhost:4201','http://'+env.ipAddress+':80','https://smilemantdm.org','https://smilemantdm.com']
}))
